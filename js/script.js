...
if (canvas && ctx) {
  ...
  class Particle {
    ...
    update() {
      ...
      // Avoid division by zero when the pointer overlaps the particle.
...
// Experience carousel (2 cards per view on desktop)
initCardCarousel({
...
// Projects carousel (3 cards per view on desktop)
initCardCarousel({
...
// Certificates carousel (3 cards per view on desktop)
initCardCarousel({
